                        ...
                        <li class="active nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
								...
								<a class="dropdown-item" href="custom.php">Custom Notification</a>
						                        ...
						                        <li class="active nav-item"><a class="nav-link" href="resources.php">Resources</a></li>						
   ...
   <!--//header-->
    ...
    <section class="promo section section-on-bg">
        <div class="container text-center">                
            <h2 class="title">Custom Notification</h2>
			<br>
		
			           <h2 class="title text-center" style="font-size:18px;">Norah Analytics’ Custom Notification tool uses machine learning to understand player behavior and reactions to certain languages and emotions. Using this, we build custom notifications and offers to suit each of your players. Create personalized experiences that maximize responses, interactions, and customer engagements. Control, adjust and fine-tune the AI-generated language to suit your games' needs. Gain insights on what works best for your business strategy and add a personal touch to each of your customer relationships. 
<br>
<Br>
<br>
    ...
    <figure class="figure col-12">
                        <img class="img-fluid" src="8.png" alt="" />
						<br>
						<Br>
						<Br>
